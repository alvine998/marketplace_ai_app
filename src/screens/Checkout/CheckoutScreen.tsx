        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity style={styles.dropdown}>
                        <View>
                            <Text style={styles.dropdownTitle}>Reguler</Text>
                            <Text style={styles.dropdownSub}>Estimasi tiba 1 - 3 Jan</Text>
                        </View>
                ...
                <View style={styles.section}>
                    ...
                    <TouchableOpacity style={styles.dropdown}>
                        <View style={styles.paymentMethod}>
                            <Icon name="credit-card" size={normalize(20)} color={COLORS.primary} />
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.summaryRow}>
                        ...
                        <Text style={styles.totalValue}>Rp 18.505.000</Text>
                    </View>
                </View>
            </ScrollView>
            ...
            <View style={styles.footer}>
                <View style={styles.footerTotal}>
                    ...
                    <Text style={styles.totalValueLarge}>Rp 18.505.000</Text>
                </View>
                <TouchableOpacity
                    style={styles.payButton}
                    onPress={() => alert('Pembayaran Berhasil!')}
                >
                    <Text style={styles.payButtonText}>Pilih Pembayaran</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
